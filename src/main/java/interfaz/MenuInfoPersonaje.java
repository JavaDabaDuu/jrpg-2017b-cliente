...
public class MenuInfoPersonaje {
  ...
  public void graficar(Graphics g, int tipoMenu) {
    ...
    // dibujo el personaje
    g.drawImage(Recursos.personaje.get(personaje.getRaza())
        .get(6)[0], x + menu.getWidth() / 2  - anchoPersonaje / 2, y + 70, 128, 128, null);
  ...
  private void graficarMenuPerderBatalla(Graphics g) {
    ...
    Pantalla.centerString(g,
        new Rectangle(x, y + 250, menu.getWidth(), 0), "¡No te rindas! Sigue luchando");
    Pantalla.centerString(g,
        new Rectangle(x, y + 270, menu.getWidth(), 0), "contra los demás personajes");
    Pantalla.centerString(g,
        new Rectangle(x, y + 290, menu.getWidth(), 0), "para aumentar tu nivel y");
    Pantalla.centerString(g,
        new Rectangle(x, y + 310, menu.getWidth(), 0), "mejorar tus atributos.");
  }
  ...
  private void graficarMenuGanarBatalla(Graphics g) {
    ...
    g.setFont(new Font("Book Antiqua", 0, 14));
    Pantalla.centerString(g,
        new Rectangle(x, y + 270, menu.getWidth(), 0), "¡Felicitaciones! Has derrotado");
    Pantalla.centerString(g,
        new Rectangle(x, y + 290, menu.getWidth(), 0), "a tu oponente, sigue así");
    Pantalla.centerString(g,
        new Rectangle(x, y + 310, menu.getWidth(), 0), "para lograr subir de nivel");
    Pantalla.centerString(g,
        new Rectangle(x, y + 330, menu.getWidth(), 0), "y mejorar tus atributos.");
  }
  ...
  private void graficarMenuSubirNivel(Graphics g) {
    ...
    Pantalla.centerString(g,
         new Rectangle(x, y + 325, menu.getWidth(), 0), String.valueOf(personaje.getNivel()));
  }
