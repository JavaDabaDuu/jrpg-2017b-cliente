...
public class EstadoDePersonaje {
  ...
  public static void dibujarEstadoDePersonaje(Graphics g, int x,
      int y, Personaje personaje, BufferedImage miniaturaPersonaje) {
    ...
    g.drawString(String.valueOf(personaje.getExperiencia()) + " / " + String 
        .valueOf(Personaje.getTablaDeNiveles()[personaje.getNivel() + 1]), x + 132, y + 70);
    g.setFont(new Font("Tahoma", Font.PLAIN, 10));
  ...
  public static void dibujarEstadoDePersonaje(Graphics g, int x,
       int y, PaquetePersonaje personaje, BufferedImage miniaturaPersonaje) {
  ...
  public static void dibujarEstadoDePersonaje(Graphics g, int x,
      int y, NonPlayableCharacter enemigo, BufferedImage miniaturaEnemigo) {
    g.drawImage(Recursos.estadoPersonaje, x, y, null);
