...
public class MenuInicio extends JFrame {
  ...
  public MenuInicio() {
    ...
    lblLogo.setIcon(new ImageIcon(MenuCarga
        .class.getResource("/frames/WOME.png")));
    ...
    btnIniciarSesion.setIcon(
        new ImageIcon(MenuJugar.class.getResource("/frames/BotonMenu.png")));
