...
public class Talk extends ComandosEscucha {
  ...
  public void ejecutar() {
    ...
    if (!(juego.getCliente().getPaqueteMensaje().getUserReceptor() == null)) {
      if (!(juego.getChatsActivos().containsKey(juego.getCliente()
    ...
    juego.getChatsActivos().get(destino).getChat().append(juego.getCliente()
        .getPaqueteMensaje().getUserEmisor() + ": "  + juego
