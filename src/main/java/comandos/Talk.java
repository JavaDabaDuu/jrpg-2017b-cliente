  ...
  public void ejecutar() {
    ...
    if (!(getJuego().getCliente().getPaqueteMensaje()
      ...
      if (!(getJuego().getChatsActivos().containsKey(getJuego().getCliente()
        ...
        getJuego().getChatsActivos().put(getJuego().getCliente()
            .getPaqueteMensaje().getUserEmisor(), chat);
      }
    ...
    getJuego().getChatsActivos().get(destino)
      .getChat().append(getJuego().getCliente()
        .getPaqueteMensaje().getUserEmisor() + ": "  + getJuego()
