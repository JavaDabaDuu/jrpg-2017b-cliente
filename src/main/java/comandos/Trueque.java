...
public class Trueque extends ComandosEscucha {
  ...
  public void ejecutar() {
    ...
    try {
      casta = (Casta) Class.forName("dominio" + "." + juego.getCliente()
          .getPaquetePersonaje().getCasta()).newInstance();
      pj = (Personaje) Class.forName("dominio" + "." + juego.getCliente().getPaquetePersonaje()
           .getRaza()).getConstructor(String.class, Integer.TYPE, Integer.TYPE, Integer
               .TYPE, Integer.TYPE, Integer.TYPE, Casta.class, Integer.TYPE, Integer
                   .TYPE, Integer.TYPE)
    ...
    if (id == paqueteComerciar.getId()) {
      ...
      pj.trueque(juego.getCliente().getPaquetePersonaje().getItems(),paqueteComerciar
          .getItemsADar(),juego.getCliente().getM1().getDar());
    } else {
      // sino soy yo esta todo ok y trueque
      pj.trueque(juego.getCliente().getPaquetePersonaje()
           .getItems(),paqueteComerciar.getItemsADar(),juego.getCliente()
               .getM1().getDar());
    }
